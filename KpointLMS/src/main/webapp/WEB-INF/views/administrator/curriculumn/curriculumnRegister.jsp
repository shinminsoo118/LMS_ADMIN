...
<c:url value="/administrator/curriculumn/curriculumnInsert.do?${_csrf.parameterName}=${_csrf.token}" var="actionURL" />
<form id="curriculumnRegistForm" name="curriculumnRegistForm" method="post" action="${actionURL}" enctype="multipart/form-data">
...
<div class="tableBox">
	...
	<table class="inputTbl2">
		...
		<tr>
			...
			<td><input type="text" name="CURPRONAME" size="52" class="tblInput" /></td>
		</tr>
		<tr>
		...
		<tr>
			<td class="left">가격</td>
			<td><input type="text" size="20" class="tblInput" name="CURPRICE" onkeyPress="InpuOnlyNumber(this);" id="CURPRICE"/> 원 (,없이 숫자만 입력)</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input type="text" size="20" class="tblInput" name="CURSALEPRICE" id="CURSALEPRICE" readonly /> 원</td>
		</tr>
		<tr>
		...
		<tr>
			<td class="left">정원</td>
			<td><input type="text" size="5" name="CURMEMBERCOUNT" class="tblInput"  onkeypress="InpuOnlyNumber(this);" /> 명</td>
		</tr>
		<tr>
