...
<c:url value="/administrator/board/setUpdate.do" var="actionURL" />
<form:form id="updateForm" commandName="boardVo"  name="updateForm" method="post" action="${actionURL}" >
...
<table class="inputTbl">
	...
	<tr>
		<th>제목</th>
		<td class="left"><form:input path="TITLE" value="${update.TITLE}" class="tblInput fullSize" /></td>
	</tr>
	<tr>
		<th>작성자</th>
	...
	<tr>
		...
		<td class="left" id="editorTd">
			...
			<%-- <form:textarea path="CONTENT" id="CONTENT" class="fullSize" style="display:none" value="${update.CONTENT}" >${update.CONTENT}</form:textarea> --%>
